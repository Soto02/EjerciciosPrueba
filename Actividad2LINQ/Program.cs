using static Actividad2LINQ.Program;

namespace Actividad2LINQ
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //Mostrar los 3 libros mas vendidos
            Console.WriteLine("Los 3 libros más vendidos: ");
            var librosMasVentas = Libros.OrderByDescending(l => l.Ventas).Take(3).ToList();
          
            foreach (var libro in librosMasVentas)
            {
                Console.WriteLine(libro.Titulo + " = " + libro.Ventas + " ventas.");
            }
            ...
            Console.WriteLine("Código y nombre de autores con menos de 10 caracteres: ");
            var autores = Autores.Where(a => a.Nombre.Replace(" ", "").Length < 10);
